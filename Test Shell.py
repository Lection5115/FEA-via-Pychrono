# -*- coding: utf-8 -*-
"""
Created on Thu Jul  1 14:24:59 2021
...
application.AddTypicalCamera(chronoirr.vector3df(0, 0, 1),  # camera location
                             chronoirr.vector3df(0.0, 0, 0.5))  # "look at" location
...
for i in range(TotalNumNodes) :
    ...
    if (i == 0) or (i==10) or (i==22) or(i==32):
        node.SetFixed(True)
