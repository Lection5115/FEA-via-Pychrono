# -*- coding: utf-8 -*-
"""
Created on Sat Jul  3 12:21:02 2021
...
mysurfmaterial.SetRestitution(0.002)
...
if (do_mesh_collision_floor) :
    ...
    mfloor = chrono.ChBodyEasyBox(2, 0.001, 2, 2700, True, True, mysurfmaterial)
    mfloor.SetBodyFixed(True)
    my_system.Add(mfloor)
    ...
    col_1.SetColor(chrono.ChColor(0, 0.5, 0))
